 ...
 * description: ${TODO}
 * autour: Knight
 * new date: 24/01/2018 on 15:37
 * e-mail: 37442216knight@gmail.com
 * update: 24/01/2018 on 15:37
 * version: v 1.0
 */
public class LuckPanLayout extends RelativeLayout {
    ...
    private CustomRotateLuckPan customLuckPan;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        radius = MinValue / 2;
        CircleX = getWidth() / 2;//宽
        CircleY = getHeight() / 2;//高
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (child instanceof CustomRotateLuckPan) {
                customLuckPan = (CustomRotateLuckPan) child;
